...
```bash
akira@github:~$ whoami
Akira Dream — Full Stack Dev | N2 Security Analyst
```
...
## 💻 About Me
I’m a Full Stack developer with a cybersecurity background as an N2 Analyst. I dive deep into app security, enjoy building backend systems, and automate everything with scripts. 

```bash
akira@github:~$ cat interests.txt
> Linux, Networking, Exploits, Flask, Automation
```
...
- 🧠 Learning Mojo and Kubernetes
- ❌ Not a fan of Go, always Py 🐍

</td><td valign="top" width="50%">

<img src="./assets/cyber.gif" align="left" style="width: 100%" />
...
---
<div align="center"><sub><code>Generated with ❤️ by Akira Dream</code></sub></div>
